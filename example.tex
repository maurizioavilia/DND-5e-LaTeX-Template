\documentclass[bg=print,letterpaper,twocolumn,openany,nodeprecatedcode,justified]{dndbook}
...
\title{Titolo della mia avventura \\
\large D\&D 5° Edizione}
\date{21/03/2022}
\author{Maurizio}
...
\part{Redazione del documento}

\chapter{Test 1}

\begin{figure*}
    \centering
    \includegraphics[width=0.935\textwidth]{img/Phandalin.png}
    
    \captionsetup{justification=centering}
    \caption{This is a wide figure that spans both columns.}
    \label{fig:Costa delle Spade}
...
|\ref| a figura numero: \ref{fig:Costa delle Spade}


|\pageref| a pagina della figura: \pageref{fig:Costa delle Spade}

\chapter{Sections}


\DndDropCapLine{T}{his package is designed to aid you in} writing beautifully typeset documents for the fifth edition of the world's greatest roleplaying game. It starts by adjusting the section formatting from the defaults in \LaTeX{} \title{} to something a bit more familiar to the reader. The chapter formatting is displayed \textbf{above}.
...
Reset counter area |\DndResetAreas|

\DndResetAreas

\DndArea{Resetted area}
...
\begin{DndSidebar}{This Is a Sidebar not flotted!}
...
\part{Mostri e oggetti magici}

\chapter{Mostri}

% Monster stat block
\begin{DndMonster}[width=\textwidth + 8pt]{Monster Foo}
  \begin{multicols}{2}
    \DndMonsterType{Medium aberration (metasyntactic variable), neutral evil}
